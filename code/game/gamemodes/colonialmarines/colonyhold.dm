...
/datum/game_mode/colonyhold
	name = "Colony Holdout"
	config_tag = "Colony Holdout"
...
/* Pre-pre-startup */
/datum/game_mode/colonyhold/can_start(bypass_checks = FALSE)
	initialize_special_clamps()
	return TRUE

/datum/game_mode/colonyhold/announce()
...
/datum/game_mode/colonyhold/get_roles_list()
	return GLOB.ROLES_HOLDOUT

////////////////////////////////////////////////////////////////////////////////////////

/* Pre-setup */
/datum/game_mode/colonyhold/pre_setup()
...
/datum/game_mode/colonyhold/post_setup()
...
/datum/game_mode/colonyhold/ds_first_landed(obj/docking_port/stationary/marine_dropship)
	. = ..()
...
/datum/game_mode/colonyhold/proc/get_valid_sentry_turfs(left, bottom, z, width, height, list/structures_to_ignore)
...
/datum/game_mode/colonyhold/proc/spawn_lz_sentry(turf/target, list/structures_to_break)
...
/datum/game_mode/colonyhold/proc/start_lz_hazards()
...
/datum/game_mode/colonyhold/proc/warn_lz_hazard(lz)
	if(!lz)
		return
...
/datum/game_mode/colonyhold/proc/spawn_lz_hazards()
...
/datum/game_mode/colonyhold/proc/clear_lz_hazards()
...
/datum/game_mode/colonyhold/proc/warn_resin_clear(obj/docking_port/mobile/marine_dropship)
 ...
 */
/datum/game_mode/colonyhold/proc/clear_proximity_resin()
 ...
 */
/datum/game_mode/colonyhold/proc/allow_proximity_resin()
	for(var/area/near_area as anything in GLOB.all_areas)
		var/area_lz = near_area.linked_lz
		if(!area_lz)
			continue
...
/datum/game_mode/colonyhold/proc/spawn_smallhosts()
...
/datum/game_mode/colonyhold/proc/map_announcement()
...
/datum/game_mode/colonyhold/proc/ares_conclude()
...
/datum/game_mode/colonyhold/process()
	. = ..()
	if(--round_started > 0)
	...
	if(!round_finished)
		...
		if(++round_checkwin >= 5) //Only check win conditions every 5 ticks.
			...
			// 	check_win()
			// round_checkwin = 0
			//TEMP SO WEDONT END INSTANTLY REMOVE LATER POLKZ
 ...
 */
/datum/game_mode/colonyhold/proc/check_hijack_explosions()
...
/datum/game_mode/colonyhold/proc/check_ground_humans()
 ...
 */
/datum/game_mode/colonyhold/proc/shake_ship()
...
/datum/game_mode/colonyhold/ds_first_drop(obj/docking_port/mobile/marine_dropship)
...
//////////////////////////
/datum/game_mode/colonyhold/check_win()
...
/datum/game_mode/colonyhold/count_humans_and_xenos(list/z_levels)
	. = ..()
...
/datum/game_mode/colonyhold/check_queen_status(hivenumber, immediately = FALSE)
...
///////////////////////////////
/datum/game_mode/colonyhold/check_finished()
...
/datum/game_mode/colonyhold/declare_completion()
	announce_ending()
	var/musical_track
	var/end_icon = "draw"
...
// for the toolbox
/datum/game_mode/colonyhold/end_round_message()
	switch(round_finished)
		if(MODE_INFESTATION_X_MAJOR)
...
/datum/game_mode/colonyhold/proc/add_current_round_status_to_end_results(special_round_status as text)
...
/datum/game_mode/colonyhold/proc/handle_round_results_statistics_output()
