...
//Holdout
GLOBAL_LIST_INIT(ROLES_HOLDOUT_COLONISTS, list(JOB_HOLDOUT_HYBRISA_REQUISITION, JOB_HOLDOUT_HYBRISA_CHIEF_REQUISITION, JOB_HOLDOUT_HYBRISA_CMO, JOB_HOLDOUT_HYBRISA_DOCTOR, JOB_HOLDOUT_HYBRISA_ENGINEER, JOB_HOLDOUT_HYBRISA_CHIEF_ENGINEER, JOB_NSPA_CINSP, JOB_NSPA_CST))
GLOBAL_LIST_INIT(ROLES_IASF, list(JOB_IASF_LT, JOB_IASF_LT_COMMANDER))
GLOBAL_LIST_INIT(ROLES_HOLDOUT, GLOB.ROLES_IASF + GLOB.ROLES_HOLDOUT_COLONISTS + GLOB.ROLES_GROUND)
